...
func (a *App) subscribeNetworkEvents(ctx context.Context) {
	...
	cancel := runtime.EventsOn(ctx, networkStatusEvent, func(data ...any) {
		a.handleNetworkSignal(data...)
	})
	a.networkEventsCancel = cancel
}

func (a *App) handleNetworkSignal(payload ...any) {
...
func parseNetworkSignal(args ...any) (networkSignal, bool) {
	if len(args) == 0 {
...
func decodeNetworkMap(value map[string]any) (networkSignal, bool) {

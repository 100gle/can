...
type DownloadEntry struct {
	...
	Key          string `json:"key" validate:"required_without=IsDir,omitempty,object-key"`
...
type TransferTask struct {
	...
	EndTime        time.Time       `json:"endTime,omitzero" ts_type:"string"`
...
func (t *TransferTask) clone() *TransferTask {
	...
	if t.CompletedParts != nil {
		...
		maps.Copy(cp.CompletedParts, t.CompletedParts)
	}

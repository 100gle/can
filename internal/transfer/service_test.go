...
func newTestTransferService(t *testing.T, driver storage.ObjectAdapter) (*Service, string) {
	t.Helper()
	store, db := newTestAccountsStore(t)
	...
	svc := NewService(accountSvc, vault, transferStore, WithWorkerCount(1), WithQueueSize(1))
...
func newFakeObjectAdapter() *fakeObjectAdapter {
	return &fakeObjectAdapter{
		objects: make(map[string][]byte),
	}
}

func (d *fakeObjectAdapter) store(bucket, key string, data []byte) {
	d.mu.Lock()
	defer d.mu.Unlock()
	d.objects[bucket+":"+key] = append([]byte(nil), data...)
}

func (d *fakeObjectAdapter) object(bucket, key string) []byte {
	d.mu.Lock()
	defer d.mu.Unlock()
	return append([]byte(nil), d.objects[bucket+":"+key]...)
}

func (d *fakeObjectAdapter) setObject(bucket, key string, data []byte) {
	d.store(bucket, key, data)
}

func (d *fakeObjectAdapter) ListObjects(context.Context, storage.ListObjectsInput) (storage.ListObjectsResult, error) {
	return storage.ListObjectsResult{}, nil
}

func (d *fakeObjectAdapter) UploadObject(ctx context.Context, bucket, key string, body io.Reader, _ int64, _ string) error {
...
func (d *fakeObjectAdapter) DownloadObject(ctx context.Context, input storage.DownloadObjectInput) (storage.ObjectDownload, error) {
	d.mu.Lock()
	d.last = input
	d.mu.Unlock()
...
func (d *fakeObjectAdapter) DeleteObject(context.Context, string, string) error {
	return nil
}

func (d *fakeObjectAdapter) DeleteObjects(_ context.Context, _ string, keys []string) (storage.DeleteObjectsResult, error) {
	return storage.DeleteObjectsResult{Deleted: keys}, nil
}

func (d *fakeObjectAdapter) CopyObject(context.Context, string, string, string, string) error {
	return nil
}

func (d *fakeObjectAdapter) HeadObject(context.Context, string, string) (storage.ObjectDescriptor, error) {
	return storage.ObjectDescriptor{}, nil
}

func (d *fakeObjectAdapter) PresignURL(context.Context, storage.PresignRequest) (string, error) {
	return "", nil
}

func (d *fakeObjectAdapter) InitiateMultipartUpload(context.Context, string, string) (string, error) {
	return "", nil
}

func (d *fakeObjectAdapter) UploadPart(context.Context, string, string, string, int, io.Reader, int64) (string, error) {
	return "", nil
}

func (d *fakeObjectAdapter) CompleteMultipartUpload(context.Context, string, string, string, map[int]string) error {
	return nil
}

func (d *fakeObjectAdapter) AbortMultipartUpload(context.Context, string, string, string) error {
	return nil
}

func (d *fakeObjectAdapter) GetObjectTags(context.Context, string, string) (map[string]string, error) {
	return nil, nil
}

func (d *fakeObjectAdapter) PutObjectTags(context.Context, string, string, map[string]string) error {
	return nil
}

func (d *fakeObjectAdapter) UpdateObjectMetadata(context.Context, string, string, storage.ObjectMetadataUpdate) error {
	return nil
}

func (d *fakeObjectAdapter) GetObjectACL(context.Context, string, string) (storage.ObjectACL, error) {
	return storage.ObjectACL{}, storage.ErrUnsupportedFeature
}

func (d *fakeObjectAdapter) PutObjectACL(context.Context, string, string, string) error {
	return storage.ErrUnsupportedFeature
}

func (d *fakeObjectAdapter) CreateSymlink(context.Context, string, string, string) error {
	return storage.ErrUnsupportedFeature
}

func (d *fakeObjectAdapter) GetSymlink(context.Context, string, string) (string, error) {
	return "", storage.ErrUnsupportedFeature
}

func (d *fakeObjectAdapter) GetObjectLockConfiguration(context.Context, string) (storage.ObjectLockConfiguration, error) {
	return storage.ObjectLockConfiguration{}, storage.ErrUnsupportedFeature
}

func (d *fakeObjectAdapter) GetObjectRetention(context.Context, string, string, string) (storage.ObjectRetentionState, error) {
	return storage.ObjectRetentionState{}, storage.ErrUnsupportedFeature
}

func (d *fakeObjectAdapter) PutObjectRetention(context.Context, storage.PutObjectRetentionInput) error {
	return storage.ErrUnsupportedFeature
}

func (d *fakeObjectAdapter) GetObjectLegalHold(context.Context, string, string, string) (storage.ObjectLegalHoldState, error) {
	return storage.ObjectLegalHoldState{}, storage.ErrUnsupportedFeature
}

func (d *fakeObjectAdapter) PutObjectLegalHold(context.Context, storage.PutObjectLegalHoldInput) error {
	return storage.ErrUnsupportedFeature
}
...
func TestWorkerScalingRace(t *testing.T) {
	...
	svc := NewService(accountSvc, vault, newTestTransferStore(t), WithWorkerCount(100))
	svc.SetWorkerCount(100)
...
func newTestAccountsStore(t *testing.T) (accounts.Store, *gorm.DB) {

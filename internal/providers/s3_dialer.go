...
// NewS3Dialer returns a production-ready dialer.
func NewS3Dialer(opts ...S3DialerOption) Dialer {
	dialer := &S3Dialer{
		factory: NewS3ClientFactory(),
...
func (d *S3Dialer) TestConnection(ctx context.Context, credentials ConnectionCredentials) error {
	if d == nil {
		return nil
	}
	localCtx := ctx
